      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(req.path, 'matchRoutes', (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.path));
            promises = (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.path).map(function (_ref2) {
              var route = _ref2.route;
              return route.loadData ? route.loadData(store) : null;
            }).filter(function (item) {
              return item instanceof Promise;
            }).map(function (promiseInstance) {
...
var Header = function Header(_ref) {
  ...
  console.log('\uD83D\uDE80 ~ file: Header.js ~ line 6 ~ Header ~ my auth status is: ', auth);
